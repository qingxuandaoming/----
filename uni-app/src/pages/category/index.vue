  ...
  <view class="category">
    <view class="layout">
      <scroll-view class="left" scroll-y>
        <view v-for="(m,i) in menus" :key="i" :class="['m-item', current===i?'active':'']" @click="current=i; toAnchor(i)">{{ m }}</view>
      </scroll-view>
...
.right { padding: 24rpx; }
.m-item { padding: 20rpx; border-bottom: 1rpx solid #eee; color: $text-secondary; }
